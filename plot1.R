...
listzip <- unzip("~/Documents/Coursera/Exploratory Data Analysis/project 1/plotdata/household_power_consumption.zip", exdir = "/Users/HBJ/Documents/Coursera/Exploratory Data Analysis/project 1/plotdata")
